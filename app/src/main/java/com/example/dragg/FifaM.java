...
public class FifaM extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fifa_m);

        //botao com link
        Button baixarFifaM = findViewById(R.id.baixarFifaM);
        baixarFifaM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // URL que você deseja abrir no navegador
                String url = "https://play.google.com/store/apps/details?id=com.ea.gp.fifamobile";
        ...
        btnVoltarClashR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(FifaM.this, Recomendado1Activity.class);
                startActivity(intent);
                finish();
            }
        });
