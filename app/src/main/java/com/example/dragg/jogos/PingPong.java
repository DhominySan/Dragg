...
public class PingPong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //botao com link
        Button baixarPingPong = findViewById(R.id.baixarPingPong);
        baixarPingPong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // URL que você deseja abrir no navegador
                String url = "https://play.google.com/store/apps/details?id=uk.co.yakuto.PingPongKing";
        ...
        //BOTAO VOLTAR
        AppCompatButton btnVoltarPingPong = findViewById(R.id.btnVoltarPingPong);
        btnVoltarPingPong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Trocar para a SecondActivity quando o botão for clicado
                Intent intent = new Intent(PingPong.this, EsporteActivity.class);
                startActivity(intent);
                finish();
            }
        });
